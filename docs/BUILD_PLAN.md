...
>
> **Last updated:** 2026-08-10 · **Phase:** 1 of 6 · **Academic year:** 2026–27
>
...
| Scene / Ask modes | 🟡 Split into `describe()` / `answer()`; **re-run on Colab not yet done** | `DEC-031` fixed the two-word scene reply in code and tests; the fix has not yet been confirmed against the real model. Ask correctly abstained on text, validating `DEC-012` |
